...
export class Settings {
    ...
    addGui(gui) {
        gui.add(this.settings, 'object', ['sphere', 'monsterfrog3', 'ninja_head', 'sphere']).name('object')
        ...
        gui.add(this.settings, 'ordinaryLevel', 0, 6, 1).name('subdivisionLevel').step(1)// .onChange((name, value) => this.onSliderChange('ordinaryLevel', value));
